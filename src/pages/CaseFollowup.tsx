  ...
  const handleSubmit = () => {
    ...
    if (storedCases) {
      try {
        ...
        const updatedCases = cases.map((c: any) => c.id === caseId ? {
          ...c,
    ...
    return <WebLayout>
        <div className="max-w-2xl mx-auto" dir="rtl">
          ...
          scale: 1
            ...
            <Button onClick={() => navigate("/my-cases")} className="bg-primary hover:bg-primary/90">
              العودة إلى قضاياتي
            </Button>
          </motion.div>
        </div>
  ...
  return <WebLayout>
      <div className="max-w-2xl mx-auto space-y-6" dir="rtl">
        <div className="text-center">
          <h1 className="text-2xl font-bold text-foreground">متابعة الموقف</h1>
        ...
        y: 0
          ...
          <div className="space-y-3">
            ...
            <Textarea id="notes" value={notes} onChange={e => setNotes(e.target.value)} placeholder="أضف أي ملاحظات إضافية حول المتابعة..." className="min-h-[120px] bg-background border-border text-foreground" />
          </div>

          {/* Submit Button */}
          <Button onClick={handleSubmit} disabled={isSubmitting} className="w-full py-6 text-lg bg-primary hover:bg-primary/90">
